...
const LINES = [
  ...
  { type: "key", text: "}" },
  { type: "blank", text: "" },
  { type: "prompt", text: "ls -1 services/" },
  { type: "ok", text: "web-apps          # full-stack SaaS, dashboards, portals ✓" },
  { type: "ok", text: "marketing-sites   # fast, SEO-ready, headless CMS ✓" },
  { type: "ok", text: "mobile-apps       # React Native · iOS + Android ✓" },
  { type: "ok", text: "apis-and-ai       # REST/GraphQL, LLM integrations ✓" },
  { type: "ok", text: "domains-hosting   # DNS, SSL, deploy — you own it all ✓" },
  { type: "blank", text: "" },
