...
1. **Install** — place this folder in your skills directory:
   ...
   ```bash
   git clone https://github.com/img2threejs/img2threejs.git ~/.claude/skills/convert-image-to-3d-model
   ```
   ...
   ```text
   ~/.claude/skills/convert-image-to-3d-model -> <your checkout>
   ~/.codex/skills/convert-image-to-3d-model  -> <your checkout>
   ```
