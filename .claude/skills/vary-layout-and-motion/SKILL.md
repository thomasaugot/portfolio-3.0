...
- **Inline Typography Images:** Embed small, pill-shaped images directly INSIDE massive headings. Use a Tailwind arbitrary value, never `style={{}}` (banned by rule 03; GSAP writes inline styles itself and hand-written ones fight it):
  `I shape <span className="mx-2 inline-block h-10 w-24 rounded-full bg-cover bg-center [background-image:url('/assets/images/x.webp')]" /> digital spaces.`
