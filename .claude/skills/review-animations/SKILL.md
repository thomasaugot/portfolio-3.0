...
description: Review existing animation or motion code against a high craft bar (derived from Emil Kowalski's design engineering philosophy) - easing, duration, interruption, exit, layout thrash, reduced-motion. Default to flagging; approval is earned. Use when asked to review, critique, check or give feedback on an animation, a transition, or how motion feels in a diff or a component. To BUILD new motion use build-animation; to audit a whole codebase use audit-animations.
---
